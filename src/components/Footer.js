      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32 relative z-10">
        <div className="flex justify-between items-center">
          <div className="space-y-8">
            <p className="text-sm leading-6 font-semibold text-text sm:text-3xl">
              Reach out to me if you would like to create an impact digitally.
            </p>
          </div>
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-500">
            &copy; 2024 Jyotsna Venkatesan. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
